  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900 dark:bg-black dark:text-zinc-100">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-0 sm:grid-cols-[260px_1fr]">
        <aside className="border-b border-zinc-200 bg-white p-4 dark:border-zinc-900 dark:bg-zinc-950 sm:min-h-screen sm:border-b-0 sm:border-r">
          ...
          <div className="mt-6 rounded-2xl border border-zinc-200 bg-gradient-to-b from-white to-zinc-50 p-4 text-sm dark:border-zinc-800 dark:from-zinc-950 dark:to-zinc-950">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <Button
                ...
                onClick={() => {
                  resetDemo();
                  // seed will re-run on next render after hydration
                }}
              >
        ...
        <main className="min-w-0">
          <header className="sticky top-0 z-10 border-b border-zinc-200 bg-white/90 backdrop-blur dark:border-zinc-900 dark:bg-zinc-950/80">
            <div className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-4 py-3">
              <div className="flex items-center gap-2 rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-600 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300">
